        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrowthStage = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlantImages_Crops_CropId",
                        column: x => x.CropId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnalysisResult = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiseaseAnalyses_PlantImages_PlantImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CropId = table.Column<int>(type: "int", nullable: false),
                    DiseaseAnalysisId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recommendations_DiseaseAnalyses_DiseaseAnalysisId",
                        column: x => x.DiseaseAnalysisId,
                        principalTable: "DiseaseAnalyses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActionLogs_Crops_CropId",
                        column: x => x.CropId,
                        principalTable: "Crops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionLogs_Recommendations_RecommendationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Alerts_Recommendations_RecommendationId",
                        column: x => x.RecommendationId,
                        principalTable: "Recommendations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionLogs_CropId_CreatedAt",
                table: "ActionLogs",
                columns: new[] { "CropId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ActionLogs_RecommendationId",
                table: "ActionLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_RecommendationId",
                table: "Alerts",
                column: "RecommendationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiseaseAnalyses_PlantImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_DiseaseAnalysisId",
                table: "Recommendations",
                column: "DiseaseAnalysisId");
